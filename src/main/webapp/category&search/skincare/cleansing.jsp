...
<body>
	...
	<div class="container">
		<div class="header text-center">
			<h2>스킨케어-클렌징</h2>
			<form action="/category&search/skincare/cleansing.jsp" method="get">
			<input class="inp_Name" placeholder="상품명" type="hidden" name="cate" value="스킨케어-클렌징">
