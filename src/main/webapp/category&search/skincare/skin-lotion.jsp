...
<body>
	...
	<div class="container">
		<div class="header text-center">
			<h2>스킨케어-스킨/로션</h2>
			<form action="/category&search/skincare/skin-lotion.jsp" method="get">
				<input class="inp_Name" placeholder="상품명" type="hidden" name="cate" value="스킨케어-스킨/로션">
