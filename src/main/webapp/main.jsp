...
<body>
	...
	%> 
						<li class="nav-item">
						<a class="nav-link active" href="./insertProdForm.jsp" style="font-size: 16px; font-weight: 600; margin-left: 27px">상품등록</a>
						</li>
	<% 
 	}
	%> 
  ...
  ================================================== -->
		...
		<!-- FOOTER -->
		<a href="" id="foot" style="margin-left: 820px;"><i
			class="fa-brands fa-facebook"></i></a> <a href="" id="foot"><i
			class="fa-brands fa-youtube"></i></a> <a href="" id="foot"><i
			class="fa-brands fa-instagram"></i></a> <a href="" id="foot"><i
